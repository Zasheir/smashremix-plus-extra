...
scope GameAndWatchPLUS2D {
    ...
    scope CloakingFix: {
        ...
        scope clear_: {
            ...
            li      a1, CharEnvColor.custom_display_lists_struct_mrgawplus_torch
            sw      r0, 0x0000(a1)      // clear high poly initialized flag
            sw      r0, 0x0014(a1)      // clear low poly initialized flag

            li      a1, CharEnvColor.custom_display_lists_struct_mrgawplus_turtle
            sw      r0, 0x0000(a1)      // clear high poly initialized flag
            sw      r0, 0x0014(a1)      // clear low poly initialized flag

            li      a1, CharEnvColor.custom_display_lists_struct_mrgawplus_fish_one
            sw      r0, 0x0000(a1)      // clear high poly initialized flag
            sw      r0, 0x0014(a1)      // clear low poly initialized flag

            li      a1, CharEnvColor.custom_display_lists_struct_mrgawplus_key
            sw      r0, 0x0000(a1)      // clear high poly initialized flag
            sw      r0, 0x0014(a1)      // clear low poly initialized flag

            li      a1, CharEnvColor.custom_display_lists_struct_mrgawplus_wind
            sw      r0, 0x0000(a1)      // clear high poly initialized flag
            sw      r0, 0x0014(a1)      // clear low poly initialized flag

            li      a1, CharEnvColor.custom_display_lists_struct_mrgawplus_parachute
            sw      r0, 0x0000(a1)      // clear high poly initialized flag
            sw      r0, 0x0014(a1)      // clear low poly initialized flag

            li      a1, CharEnvColor.custom_display_lists_struct_mrgawplus_card_one
            sw      r0, 0x0000(a1)      // clear high poly initialized flag
            sw      r0, 0x0014(a1)      // clear low poly initialized flag

            li      a1, CharEnvColor.custom_display_lists_struct_mrgawplus_card_two
            sw      r0, 0x0000(a1)      // clear high poly initialized flag
            sw      r0, 0x0014(a1)      // clear low poly initialized flag

            li      a1, CharEnvColor.custom_display_lists_struct_mrgawplus_card_three
            sw      r0, 0x0000(a1)      // clear high poly initialized flag
            sw      r0, 0x0014(a1)      // clear low poly initialized flag

            li      a1, CharEnvColor.custom_display_lists_struct_mrgawplus_card_four
            sw      r0, 0x0000(a1)      // clear high poly initialized flag
            sw      r0, 0x0014(a1)      // clear low poly initialized flag

            li      a1, CharEnvColor.custom_display_lists_struct_mrgawplus_card_five
            sw      r0, 0x0000(a1)      // clear high poly initialized flag
            sw      r0, 0x0014(a1)      // clear low poly initialized flag

            li      a1, CharEnvColor.custom_display_lists_struct_mrgawplus_card_six
            sw      r0, 0x0000(a1)      // clear high poly initialized flag
            sw      r0, 0x0014(a1)      // clear low poly initialized flag

            li      a1, CharEnvColor.custom_display_lists_struct_mrgawplus_card_seven
            sw      r0, 0x0000(a1)      // clear high poly initialized flag
            sw      r0, 0x0014(a1)      // clear low poly initialized flag

            li      a1, CharEnvColor.custom_display_lists_struct_mrgawplus_card_eight
            sw      r0, 0x0000(a1)      // clear high poly initialized flag
            sw      r0, 0x0014(a1)      // clear low poly initialized flag

            li      a1, CharEnvColor.custom_display_lists_struct_mrgawplus_card_nine
            sw      r0, 0x0000(a1)      // clear high poly initialized flag
            sw      r0, 0x0014(a1)      // clear low poly initialized flag

            li      a1, CharEnvColor.custom_display_lists_struct_mrgawplus_fire_one
            sw      r0, 0x0000(a1)      // clear high poly initialized flag
            sw      r0, 0x0014(a1)      // clear low poly initialized flag

            li      a1, CharEnvColor.custom_display_lists_struct_mrgawplus_fire_two
            sw      r0, 0x0000(a1)      // clear high poly initialized flag
            sw      r0, 0x0014(a1)      // clear low poly initialized flag

            li      a1, CharEnvColor.custom_display_lists_struct_mrgawplus_fish_two
            sw      r0, 0x0000(a1)      // clear high poly initialized flag
            jr      ra                  // return
            sw      r0, 0x0014(a1)      // clear low poly initialized flag
        }
