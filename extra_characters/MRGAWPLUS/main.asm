...
scope GameAndWatchPLUS2D {
    ...
    Character.table_patch_start(variants, Character.id.MRGAWPLUS, 0x4)
    db      Character.id.NONE
    db      Character.id.NONE // set as POLYGON variant for MRGAWPLUS
    db      Character.id.NONE
    db      Character.id.NONE
    OS.patch_end()

    ; Character.table_patch_start(variant_original, Character.id.NDRM, 0x4)
    ; dw      Character.id.MRGAWPLUS // set Dr. Mario as original character (not Mario, who NDRM is a clone of)
    ; OS.patch_end()
