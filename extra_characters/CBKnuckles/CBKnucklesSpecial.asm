if !{defined __CBKNUCKLES_SPECIAL__} {
define __CBKNUCKLES_SPECIAL__()

// CBKnucklesSpecial.asm

// This file contains subroutines used by CBKnuckles' special moves.

// @ Description
// Refreshes USP flag when hit
scope CBKnucklesUSPRefresh: {
    jr  ra
    sw  r0, 0x0ADC(a0)                      // set up special bool to FALSE
}

Character.table_patch_start(on_hit, Character.id.CBKNUCKLES, 0x4)
dw CBKnucklesUSPRefresh;
OS.patch_end()
...
scope CBKnucklesUSP {
    ...
    scope air_initial_: {
        ...
        lli     a1, CBKnuckles.Action.Spring // a1(action id) = Spring
    ...
    scope check_spring_bounce_: {
        ...
        _knuckles:
        // Change action for these actions
        lli     t4, CBKnuckles.Action.DiveAirBegin
        beq     t3, t4, _change_action
        lli     t4, CBKnuckles.Action.DiveAirLoop
        beq     t3, t4, _change_action
        lli     t4, CBKnuckles.Action.DiveLand
        beq     t3, t4, _change_action
        nop
...
scope CBKnucklesNSP {
    ...
    scope air_begin_initial_: {
        ...
        lw      at, 0x0AE0(v0)
        beqzl   at, _glide
        addiu   a1, r0, CBKnuckles.Action.NSP_Air_Begin // a1(action id) = NSP_Air_Begin

        jal     CBKnucklesDive.air_initial_ // a1(transition subroutine) = dive punch air initial
        nop
        b       _end
        lw      ra, 0x1C(sp)
    ...
    scope air_wait_initial_: {
        ...
        lli     a1, CBKnuckles.Action.NSP_Air_Wait // a1(action id) = NSP_Air_Wait
        or      a2, r0, r0                  // a2(starting frame) = 0
        lui     a3, 0x3F80                  // a3(frame speed multiplier) = 1.0
        lli     t6, 0x0800                  // ~
        jal     0x800E6F24                  // change action
    ...
    scope air_common_interrupt_: {
        ...
        slti    at, t0, -39                 // ~
        jal     CBKnucklesUSP.air_initial_  // do USP
        nop                                 // ~
        ...
        nop                                 // ~
        jal     CBKnucklesDSP.air_charge_initial_ // do DSP
        nop                                 // ~
        b       _end                        // go to function end
        lw      ra, 0x14(sp)                // load ra in delay slot
    ...
    scope air_turn_initial_: {
        ...
        _set_status:
        lli     a1, CBKnuckles.Action.NSP_Turn // a1(action id) = NSP_Turn
    ...
    scope air_end_initial_: {
        ...
        lli     a1, CBKnuckles.Action.NSP_Air_End // a1(action id) = NSP_Air_End
        jal     0x800E6F24                  // change action
        sw      r0, 0x0010(sp)              // argument 4 = 0
        jal     0x800E0830                  // unknown common subroutine
    ...
    scope air_common_collision_: {
        ...
        _climb_test:
        jal     CBKnucklesClimb.climb_initial_collision_ // Initial collision test
        nop                                 // ~
        ...
        addiu   at, r0, CBKnucklesClimb.CLIMB_DURATION // Load CLIMB_DURATION
        sw      at, 0xB18(t0)               // Store CLIMB_DURATION
        jal     CBKnucklesClimb.climb_wait_initial_ // Go to climb wait
...
scope CBKnucklesClimb {
    ...
    scope climb_wait_initial_: {
        ...
        lli     a1, CBKnuckles.Action.NSP_Climb_Wait // a1(action id) = NSP_Air_Begin
    ...
    scope climb_common_main_: {
        ...
        lli     at, CBKnuckles.Action.NSP_Climb_MoveUp // Run only if Knuckles is moving
        beq     at, t0, _check_stick        // Knuckles is moving up, check stick range

        lli     at, CBKnuckles.Action.NSP_Climb_MoveDown // ~
        ...
        jal     CBKnucklesNSP.air_end_initial_ // transition to NSP_Air_End
    ...
    scope climb_wait_interrupt_: {
        ...
        lli     a1, CBKnuckles.Action.NSP_Climb_MoveUp // ~

        _check_movedown:
        beqzl   at, _check_jump             // ...then check for jump inputs
        lhu     t0, 0x1BE(s1)               // Load tapped buttons

        lli     a1, CBKnuckles.Action.NSP_Climb_MoveDown

        _climb_move:
        jal     CBKnucklesClimb.climb_move_initial_
        ...
        jal     CBKnucklesClimb.climb_jump_setup_
    ...
    scope climb_initial_collision_: {
        ...
        _climb_action:
        jal     CBKnucklesClimb.climb_cliff_initial_ // ftCommonCliffQuickOrSlowSetStatus
        ...
        jal     CBKnucklesNSP.air_end_initial_ // ~
        lui     a2, 0x3F80                  // Anim speed = 1.0x
    ...
    scope climb_jostle_physics_: {
        ...
        addiu   t2, t2, -(CBKnuckles.Action.ClimbWait) // Subtract climb wait status ID from status ID
        sltiu   at, t2, (CBKnuckles.Action.ClimbDown - CBKnuckles.Action.ClimbWait + 1) // at = 1 if any Climb action, 0 otherwise
    ...
    scope climb_move_physics_: {
        ...
        jal     CBKnucklesClimb.climb_jostle_physics_
        nop                                 // ~
...
scope CBKnucklesDive {
    ...
    scope ground_initial_: {
        ...
        _glide:
        jal     CBKnucklesNSP.air_begin_initial_ // a1(transition subroutine) = glide air initial
        ...
        lli     a1, CBKnuckles.Action.DiveGround // a1 = action id
        _change_action:
    ...
    scope begin_landing_: {
        ...
        lli     a1, CBKnuckles.Action.DiveLand // a1 = action id
    ...
    scope air_initial_: {
        ...
        lli     a1, CBKnuckles.Action.DiveAirBegin // a1 = action id
        _change_action:
    ...
    scope air_physics_: {
        ...
        lli     t2, CBKnuckles.Action.DiveAirLoop
    ...
    scope air_collision_: {
        ...
        lli     at, CBKnuckles.Action.DiveAirLoop
    ...
    scope loop_initial_: {
        ...
        lli     a1, CBKnuckles.Action.DiveAirLoop // a1 = action id
        _change_action:
        lli     a2, 0x0000                  // a2 = 0 (begin action frame)
        jal     0x800E6F24                  // change action
...
scope CBKnucklesDSP {
    ...
    scope ground_charge_initial_: {
        ...
        lli     a1, CBKnuckles.Action.DSP_Ground_Charge // a1(action id) = DSP_Ground_Charge
        or      a2, r0, r0                  // a2(starting frame) = 0
        lui     a3, 0x3F80                  // a3(frame speed multiplier) = 1.0
        jal     0x800E6F24                  // change action
        sw      r0, 0x0010(sp)              // argument 4 = 0
    ...
    scope air_charge_initial_: {
        ...
        sw      ra, 0x0014(sp)              // ~
        sw      a0, 0x0018(sp)              // store ra, a0
        lli     a1, CBKnuckles.Action.DSP_Air_Charge // a1(action id) = DSP_Air_Charge
        or      a2, r0, r0                  // a2(starting frame) = 0
        lui     a3, 0x3F80                  // a3(frame speed multiplier) = 1.0
        jal     0x800E6F24                  // change action
        sw      r0, 0x0010(sp)              // argument 4 = 0
    ...
    scope ground_move_initial_: {
        ...
        sw      ra, 0x0014(sp)              // ~
        sw      a0, 0x0018(sp)              // store ra, a0
        lli     a1, CBKnuckles.Action.DSP_Ground_Move // a1(action id) = DSP_Ground_Move
        or      a2, r0, r0                  // a2(starting frame) = 0
        lui     a3, 0x3F80                  // a3(frame speed multiplier) = 1.0
        jal     0x800E6F24                  // change action
        sw      r0, 0x0010(sp)              // argument 4 = 0
    ...
    scope air_move_initial_: {
        ...
        lw      a0, 0x0084(a0)              // a0 = player struct
        lw      a0, 0x0018(sp)              // a0 = player object
        lli     a1, CBKnuckles.Action.DSP_Air_Move // a1(action id) = DSP_Air_Move
        or      a2, r0, r0                  // a2(starting frame) = 0
        lui     a3, 0x3F80                  // a3(frame speed multiplier) = 1.0
        jal     0x800E6F24                  // change action
        sw      r0, 0x0010(sp)              // argument 4 = 0
    ...
    scope ground_move_transition_: {
        ...
        sw      a0, 0x0034(sp)              // 0x0034(sp) = player struct
        lw      a0, 0x0038(sp)              // a0 = player object
        lli     a1, CBKnuckles.Action.DSP_Ground_Move // a1(action id) = DSP_Ground_End
        lw      a2, 0x0078(a0)              // a2(starting frame) = current animation frame
        lui     a3, 0x3F80                  // a3(frame speed multiplier) = 1.0
        jal     0x800E6F24                  // change action
        sw      r0, 0x0010(sp)              // argument 4 = 0
    ...
    scope air_jump_initial_: {
        ...
        lw      a0, 0x0084(a0)              // a0 = player struct
        lw      a0, 0x0018(sp)              // a0 = player object
        lli     a1, CBKnuckles.Action.DSP_Air_Jump // a1(action id) = DSP_Air_Move
        or      a2, r0, r0                  // a2(starting frame) = 0
        lui     a3, 0x3F80                  // a3(frame speed multiplier) = 1.0
        jal     0x800E6F24                  // change action
        sw      r0, 0x0010(sp)              // argument 4 = 0
    ...
    scope ground_end_initial_: {
        ...
        sw      ra, 0x0014(sp)              // ~
        sw      a0, 0x0018(sp)              // store ra, a0
        lli     a1, CBKnuckles.Action.DSP_Ground_End // a1(action id) = DSP_Ground_End
        or      a2, r0, r0                  // a2(starting frame) = 0
        lui     a3, 0x3F80                  // a3(frame speed multiplier) = 1.0
        jal     0x800E6F24                  // change action
        sw      r0, 0x0010(sp)              // argument 4 = 0
    ...
    scope air_end_initial_: {
        ...
        sw      ra, 0x0014(sp)              // ~
        sw      a0, 0x0018(sp)              // store ra, a0
        lli     a1, CBKnuckles.Action.DSP_Air_End // a1(action id) = DSP_Air_End
        or      a2, r0, r0                  // a2(starting frame) = 0
        lui     a3, 0x3F80                  // a3(frame speed multiplier) = 1.0
        jal     0x800E6F24                  // change action
        sw      r0, 0x0010(sp)              // argument 4 = 0
