...
scope GFXRoutine {
    ...
    LIGHT_SUBROUTINE:; CREATE_GFX(-1, 0x7E, 0, 0, 0, 0, 0, 0); OVERLAY(0xFFFFDDAA); WAIT(1); OVERLAY(0xFFFF6496); WAIT(1); RETURN()
    LIGHT_SMOKE_SUBROUTINE:; CREATE_GFX(-1, 0x7E, 0, 0, 0, 0, 0, 0); BEGIN_LOOP(2); OVERLAY(0xFFFFDD64); WAIT(1); OVERLAY(0xFFFF64D2); WAIT(1); END_LOOP(); RETURN()
    LIGHT_1:; BEGIN_LOOP(4); SUBROUTINE(LIGHT_SUBROUTINE); END_LOOP(); BEGIN_LOOP(4); SUBROUTINE(LIGHT_SMOKE_SUBROUTINE); END_LOOP(); END()
    LIGHT_2:; BEGIN_LOOP(8); SUBROUTINE(LIGHT_SUBROUTINE); END_LOOP(); BEGIN_LOOP(8); SUBROUTINE(LIGHT_SMOKE_SUBROUTINE); END_LOOP(); END()
    LIGHT_3:; BEGIN_LOOP(16); SUBROUTINE(LIGHT_SUBROUTINE); END_LOOP(); BEGIN_LOOP(16); SUBROUTINE(LIGHT_SMOKE_SUBROUTINE); END_LOOP(); END()
    LIGHT_4:; BEGIN_LOOP(24); SUBROUTINE(LIGHT_SUBROUTINE); END_LOOP(); BEGIN_LOOP(20); SUBROUTINE(LIGHT_SMOKE_SUBROUTINE); END_LOOP(); END()
    ...
    add_gfx_routine(LIGHT_1, LIGHT_1, 100, OS.FALSE)
    add_gfx_routine(LIGHT_2, LIGHT_2, 100, OS.FALSE)
    add_gfx_routine(LIGHT_3, LIGHT_3, 100, OS.FALSE)
    add_gfx_routine(LIGHT_4, LIGHT_4, 100, OS.FALSE)
