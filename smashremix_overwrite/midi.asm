...
scope MIDI {
    ...
    insert_midi(DRAGONKING, OS.TRUE, OS.TRUE, "Dragon King", dragonking, 75)
    ...
    insert_midi(SNOWGO, OS.TRUE, OS.TRUE, "Snow Go", crash2, 223)
    insert_midi(FUTUREFRENZY, OS.TRUE, OS.TRUE, "Future Frenzy", crash3, 104)
