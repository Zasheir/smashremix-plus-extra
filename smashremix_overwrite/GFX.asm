...
scope GFX {
    ...
    add_gfx_texture_block(Gold Sparkles Static, 3, 0, 2, 0x20, 0x20)
    add_gfx_texture(gfx/gold_sparkles_static-1.rgba5551)
    add_gfx_texture(gfx/gold_sparkles_static-2.rgba5551)
    add_gfx_texture(gfx/gold_sparkles_static-3.rgba5551)

    add_gfx_texture_block(Light Spark, 6, 0, 2, 0x20, 0x20)
    add_gfx_texture(gfx/light_spark-1.rgba5551)
    add_gfx_texture(gfx/light_spark-2.rgba5551)
    add_gfx_texture(gfx/light_spark-3.rgba5551)
    add_gfx_texture(gfx/light_spark-4.rgba5551)
    add_gfx_texture(gfx/light_spark-5.rgba5551)
    add_gfx_texture(gfx/light_spark-6.rgba5551)
    ...
    add_gfx(Gold Sparkles Static, gfx/gold_sparkles_static_instructions.bin, id.EXPLOSION)
    add_gfx(Light Spark, gfx/light_spark_instructions.bin, id.FIRE)
