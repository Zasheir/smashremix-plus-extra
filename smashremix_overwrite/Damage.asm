...
scope Damage {
    ...
    scope on_hit_gfx {
        ...
        constant LIGHT(create_slash_gfx_)
        table:
    ...
    // @ Description
    // Jump table routine for starting "light" GFX Routine on hit
    scope begin_light_gfx_routine_: {
        addiu   a1, a3, GFXRoutine.id.LIGHT_1 // a1 = base LIGHT effect id + damage level
        jal     0x800E9814                  // begin GFX routine
        or      a2, r0, r0                  // a2 = 0
        j       on_hit_routine.return       // return
        nop
    ...
    scope on_hit_routine {
        ...
        constant LIGHT(begin_light_gfx_routine_)
        table:
        constant table_origin(origin())
        dw NORMAL                           // 0x0 - normal
        dw FIRE                             // 0x1 - fire
    ...
    scope stun_electric_action_: {
        ...
        lli     at, Damage.id.LIGHT         // at = id.LIGHT
        beq     t0, at, _electric           // branch if damage type = LIGHT
    ...
    add_damage_type(LIGHT, on_hit_gfx.LIGHT, on_hit_routine.LIGHT)
